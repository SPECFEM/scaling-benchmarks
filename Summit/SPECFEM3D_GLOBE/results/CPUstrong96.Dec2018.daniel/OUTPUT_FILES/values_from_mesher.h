 ...
 !
 ! maximum number of points per region =  2692565
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =  8077695
 !
 ! total elements per slice =  47040
 ! total points per slice =  3103843
 !
 ! the time step of the solver will be DT =  0.1899999976  (s)
 ! the (approximate) minimum period resolved will be =  17.00000000  (s)
 !
 ...
 ! average distance between points in degrees =  0.8789062500E-01
 ! average distance between points in km =  9.772991180
 ! average size of a spectral element in km =  39.09196472
 !
 ...
 !
 ! size of static arrays per slice =  1673.42129199999999  MB
 !                                 =  1595.89890670776367  MiB
 !                                 =  1.67342129200000000  GB
 !                                 =  1.55849502608180046  GiB
 !
 ...
 !
 ! size of static arrays for all slices =  160.648444031999986  GB
 !                                      =  149.615522503852844  GiB
 !                                      =  0.160648444031999987  TB
 !                                      =  0.146108908695168793  TiB
 !
 
 integer, parameter :: NEX_XI_VAL =  256
 integer, parameter :: NEX_ETA_VAL =  256
 
 integer, parameter :: NSPEC_CRUST_MANTLE =  40960
 integer, parameter :: NSPEC_OUTER_CORE =  3840
 integer, parameter :: NSPEC_INNER_CORE =  2240
 
 integer, parameter :: NGLOB_CRUST_MANTLE =  2692565
 integer, parameter :: NGLOB_OUTER_CORE =  257729
 integer, parameter :: NGLOB_INNER_CORE =  153549
 
 integer, parameter :: NSPECMAX_ANISO_IC =  1
 
 integer, parameter :: NSPECMAX_ISO_MANTLE =  40960
 integer, parameter :: NSPECMAX_TISO_MANTLE =  40960
 integer, parameter :: NSPECMAX_ANISO_MANTLE =  1
 
 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =  40960
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =  2240
 
 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =  40960
 ...
 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =  2692565
 ...
 integer, parameter :: NSPEC_OUTER_CORE_ROTATION =  3840
 ...
 integer, parameter :: ATT4_VAL =  40960
 integer, parameter :: ATT5_VAL =  2240
 
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =  1120
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =  1120
 integer, parameter :: NSPEC2D_BOTTOM_CM =  256
 integer, parameter :: NSPEC2D_TOP_CM =  4096
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =  280
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =  280
 integer, parameter :: NSPEC2D_BOTTOM_IC =  64
 integer, parameter :: NSPEC2D_TOP_IC =  64
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =  288
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =  288
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =  34
