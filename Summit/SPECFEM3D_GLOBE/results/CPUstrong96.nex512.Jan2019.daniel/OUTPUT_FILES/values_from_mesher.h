 ...
 !
 ! maximum number of points per region =  17772461
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =  53317383
 !
 ! total elements per slice =  322560
 ! total points per slice =  21007055
 !
 ! the time step of the solver will be DT =  0.1068750024  (s)
 ! the (approximate) minimum period resolved will be =  8.500000000  (s)
 !
 ...
 ! average distance between points in degrees =  0.4394531250E-01
 ! average distance between points in km =  4.886495590
 ! average size of a spectral element in km =  19.54598236
 !
 ...
 !
 ! size of static arrays per slice =  10920.0084920000008  MB
 !                                 =  10414.1316337585449  MiB
 !                                 =  10.9200084919999991  GB
 !                                 =  10.1700504235923290  GiB
 !
 ...
 !
 ! size of static arrays for all slices =  1048.32081523200009  GB
 !                                      =  976.324840664863586  GiB
 !                                      =  1.04832081523200005  TB
 !                                      =  0.953442227211780846  TiB
 !
 
 integer, parameter :: NEX_XI_VAL =  512
 integer, parameter :: NEX_ETA_VAL =  512
 
 integer, parameter :: NSPEC_CRUST_MANTLE =  273408
 integer, parameter :: NSPEC_OUTER_CORE =  31488
 integer, parameter :: NSPEC_INNER_CORE =  17664
 
 integer, parameter :: NGLOB_CRUST_MANTLE =  17772461
 integer, parameter :: NGLOB_OUTER_CORE =  2064269
 integer, parameter :: NGLOB_INNER_CORE =  1170325
 
 integer, parameter :: NSPECMAX_ANISO_IC =  1
 
 integer, parameter :: NSPECMAX_ISO_MANTLE =  273408
 integer, parameter :: NSPECMAX_TISO_MANTLE =  273408
 integer, parameter :: NSPECMAX_ANISO_MANTLE =  1
 
 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =  273408
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =  17664
 
 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =  273408
 integer, parameter :: NSPEC_INNER_CORE_STR_OR_ATT =  17664
 ...
 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =  17772461
 ...
 integer, parameter :: NSPEC_OUTER_CORE_ROTATION =  31488
 ...
 integer, parameter :: ATT4_VAL =  273408
 integer, parameter :: ATT5_VAL =  17664
 
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =  4192
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =  4192
 integer, parameter :: NSPEC2D_BOTTOM_CM =  1024
 integer, parameter :: NSPEC2D_TOP_CM =  16384
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =  1104
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =  1104
 integer, parameter :: NSPEC2D_BOTTOM_IC =  256
 integer, parameter :: NSPEC2D_TOP_IC =  256
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =  1200
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =  1200
 integer, parameter :: NSPEC2D_BOTTOM_OC =  256
 integer, parameter :: NSPEC2D_TOP_OC =  1024
