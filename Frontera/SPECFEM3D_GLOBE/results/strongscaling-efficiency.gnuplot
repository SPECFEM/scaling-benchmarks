...
# smooth results
#plot 'strongscaling.dat' u 2:(d2($2,$5/300.0)):xtic(2) smooth cspline ls 1 t 'Frontera CPU','' u 2:(d2($2,$5/300.0)) w p ls 1 t '', 100 lt 0 t 'ideal'

# linear
plot 'strongscaling.dat' u 2:(d2($2,$5/300.0)):xtic(2) w lp ls 1 t 'Frontera (CLX)','' u 2:(d2($2,$5/300.0)) w p ls 1 t '', 100 lt 0 t 'ideal'
